...
function render(variables = {}) {
  ...
  if (variables.twitter == null) variables.twitter = "Colinaleon22";
  if (variables.github == null) variables.github = "victorcolina22";
  if (variables.linkedin == null)
    variables.linkedin = "victor-colina-leon-8a38541b8";
  if (variables.instagram == null) variables.instagram = "victoracl22";
